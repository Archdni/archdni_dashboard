  ...
  Map<String, Map<String, String>> get keys => {
        "ar": {
          ...
          'verification_code_has_been_sent_to_your_email_please_check_your_email_and_enter_the_code':
              'رمز التحقق تم إرساله إلى بريدك الإلكتروني، يرجى التحقق من البريد الإلكتروني وإدخال الرمز',
          "not your email?":
        ...
        "en": {
          ...
          "complete_your_profile_and_get_your_first_order":
              "Complete your profile and get your first order",
          "full_name": "Full name",
          "Enter your full name":
              "Enter your full name",
